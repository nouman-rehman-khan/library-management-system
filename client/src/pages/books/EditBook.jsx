...
const EditBook = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [bookData, categoriesData, publishersData, authorsData] = await Promise.all([
          getBookById(id),
          getAllCategories(),
          getAllPublishers(),
          getAllAuthors(),
        ...
        setFormData({
          ...
          authorIds: bookData.authors?.map(author => author.AuthorID) || [],
        });
  ...
  if (loading) return <LoadingSpinner message="Loading book data..." />;
  ...
  return (
    <Container maxWidth="md">
      ...
      <PageHeader title={`Edit Book: ${formData.title}`} />
